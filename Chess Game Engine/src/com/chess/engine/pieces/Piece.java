...
public abstract class Piece {
	...
	private final int cashedHasCode;
	...
	public Piece (final PieceType pieceType, 
		...
		this.cashedHasCode = computeHasCode();
	}
	private int computeHasCode() {
	...
	public boolean equals(final Object other){
		...
		return piecePosition == otherPiece.getPiecePosition() && this.pieceType == otherPiece.getPieceType() &&
			   pieceAlliance == otherPiece.getPieceAlliance() && this.isFirstMove == otherPiece.isFirstMove();	
	}
	@Override
	public int hashCode(){
	  return this.cashedHasCode;
	}
