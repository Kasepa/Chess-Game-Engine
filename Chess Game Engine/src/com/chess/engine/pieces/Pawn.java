...
public class Pawn extends Piece{
	...
	public Collection<Move> calculateLegalMoves(final Board board) {
		...
		if(currentCandidateOffset == 8 && !board.getTile(candidateDestinationCoordinate).isTileOcuppied()){
			...
			if(!board.getTile(behindCandidateDestinationCoordinate).isTileOcuppied() && 
					!board.getTile(candidateDestinationCoordinate).isTileOcuppied()) {
					legalMoves.add(new PawnJump(board, this, candidateDestinationCoordinate));
			}
		 } else if(currentCandidateOffset == 7 && 
				 !((BoardUtils.EIGHTH_COLUMN[this.piecePosition] && this.pieceAlliance.isWhite() ||
				 (BoardUtils.FIRST_COLUMN[this.piecePosition] && this.pieceAlliance.isBlack()) ))){
			 if(board.getTile(candidateDestinationCoordinate).isTileOcuppied()){
