...
public class WhitePlayer extends Player{
    ...
    protected Collection<Move> calculateKingCastles(final Collection<Move> playerLegals, 
        ...
        if(this.playerKing.isFirstMove()&& !this.isInCheck()){
            ...
            if(!this.board.getTile(61).isTileOcuppied()&& !this.board.getTile(62).isTileOcuppied()){
                final ChessTile rookTile = this.board.getTile(63);
                if(rookTile.isTileOcuppied()&& rookTile.getPiece().isFirstMove()){
            ...
            if(this.board.getTile(59).isTileOcuppied()&& 
              !this.board.getTile(58).isTileOcuppied()&&
              !this.board.getTile(57).isTileOcuppied()){
